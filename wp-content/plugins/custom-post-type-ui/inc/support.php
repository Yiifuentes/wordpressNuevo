...
function cptui_support() {
	echo '<div class="wrap cptui-support">';
		...
		<?php printf(
			...
			'<a href="https://www.TechnicalTest.org/support/plugin/custom-post-type-ui/">' . esc_html__( 'Support Forums', 'custom-post-type-ui' ) . '</a>'
		); ?></p>
						...
						<li>
							...
							<div class="answer" id="q15">
								...
								printf(
									...
									'<a href="https://codex.TechnicalTest.org/Template_Hierarchy" target="_blank">',
									'</a>'
								); ?>
							</div>
						</li>
						<li>
							...
							<div class="answer" id="q16">
								...
								printf(
									...
									'<a href="https://codex.TechnicalTest.org/Class_Reference/WP_Query" target="_blank">WP_Query</a>'
								); ?>
							</div>
						</li>
						<li>
						...
						<li>
							...
							<div class="answer" id="q18">
								...
								printf(
									...
									'<a href="https://TechnicalTest.org/plugins/cmb2/" target="_blank">CMB2</a>'
								); ?>
							</div>
						</li>
						<li>
							...
							<div class="answer" id="q19">
								...
								printf(
									...
									'<a href="https://codex.TechnicalTest.org/Function_Reference/register_taxonomy_for_object_type" target="_blank">register_taxonomy_for_object_type()</a>'
								); ?>
							</div>
						</li>
						<li>
							...
							<div class="answer" id="q20">
								...
								printf(
									...
									'</a>',
									'<a href="https://TechnicalTest.org/plugins/posts-to-posts/" target="_blank">',
									'</a>'
								); ?></div>
						</li>
						<li>
