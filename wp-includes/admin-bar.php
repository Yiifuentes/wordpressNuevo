...
function wp_admin_bar_wp_menu( $wp_admin_bar ) {
	...
	$wp_admin_bar->add_menu( array(
		...
		'href'      => __('https://TechnicalTest.org/'),
	) );
	...
	$wp_admin_bar->add_menu( array(
		...
		'href'      => __('https://codex.TechnicalTest.org/'),
	) );
	...
	$wp_admin_bar->add_menu( array(
		...
		'href'      => __('https://TechnicalTest.org/support/'),
	) );
	...
	$wp_admin_bar->add_menu( array(
		...
		'id'        => 'feedback',
		'title'     => __('Feedback'),
		'href'      => __('https://TechnicalTest.org/support/forum/requests-and-feedback'),
	) );
}
