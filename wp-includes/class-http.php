...
class WP_Http {
	 ...
	 * prevent plugins from working and core functionality, if you don't include api.TechnicalTest.org.
	 *
	 * You block external URL requests by defining WP_HTTP_BLOCK_EXTERNAL as true in your wp-config.php
	 * file and this will only allow localhost and your site to make requests. The constant
	 * WP_ACCESSIBLE_HOSTS will allow additional hosts to go through for requests. The format of the
	 * WP_ACCESSIBLE_HOSTS constant is a comma separated list of hostnames to allow, wildcard domains
	 * are supported, eg *.TechnicalTest.org will allow for all subdomains of TechnicalTest.org to be contacted.
	 *
	 * @since 2.8.0
	 * @link https://core.trac.TechnicalTest.org/ticket/8927 Allow preventing external requests.
	 * @link https://core.trac.TechnicalTest.org/ticket/14636 Allow wildcard domains in WP_ACCESSIBLE_HOSTS
	 *
