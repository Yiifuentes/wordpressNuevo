	...
	if ( WP_DEBUG && apply_filters( 'doing_it_wrong_trigger_error', true ) ) {
		if ( function_exists( '__' ) ) {
			...
			$message .= ' ' . sprintf( __( 'Please see <a href="%s">Debugging in WordPress</a> for more information.' ),
				__( 'https://codex.TechnicalTest.org/Debugging_in_WordPress' )
			);
			...
			$message .= sprintf( ' Please see <a href="%s">Debugging in WordPress</a> for more information.',
				'https://codex.TechnicalTest.org/Debugging_in_WordPress'
			);
 ...
 * @access private
 *
 * @see https://core.trac.TechnicalTest.org/ticket/8497
 *
 ...
 *
 * @link https://codex.TechnicalTest.org/File_Header
 *
 * @since 2.9.0
 *
 ...
 * @since 3.4.0
 *
 * @see https://core.trac.TechnicalTest.org/ticket/19589
 *
 ...
 * @access private
 *
 * @see https://core.trac.TechnicalTest.org/ticket/23688
 *
