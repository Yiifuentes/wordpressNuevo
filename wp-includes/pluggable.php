...
function wp_mail( $to, $subject, $message, $headers = '', $attachments = array() ) {
	...
	/* If we don't have an email from the input headers default to TechnicalTest@$sitename
	...
	if ( !isset( $from_email ) ) {
		...
		$from_email = 'TechnicalTest@' . $sitename;
	}
...
function wp_notify_postauthor( $comment_id, $deprecated = null ) {
	...
	$wp_email = 'TechnicalTest@' . preg_replace('#^www\.#', '', strtolower($_SERVER['SERVER_NAME']));
 ...
 * {@link https://api.TechnicalTest.org/secret-key/1.1/salt/ secret key created} just
 * for you.
 *
 ...
 * @since 2.5.0
 *
 * @link https://api.TechnicalTest.org/secret-key/1.1/salt/ Create secrets for wp-config.php
 *
